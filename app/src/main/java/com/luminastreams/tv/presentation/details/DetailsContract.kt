...
// ─────────────────────────────────────────────────────────────────
// DetailsContract.kt
// אוסף: State + Events + Models משותפים לשכבת Details.
// DetailsScreen.kt → רק UI Composables
// DetailsViewModel.kt → רק לוגיקה עסקית
// ─────────────────────────────────────────────────────────────────

// ── Domain models (specific to Details layer) ────────────────────
@Immutable
